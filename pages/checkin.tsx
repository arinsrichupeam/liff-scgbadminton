    ...
    <div className="flex min-h-full items-center justify-center pl-10 pr-10 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <form action="/api/checkin" method="post">
            ...
            <div className="ml-4 flex flex-1 flex-col">
              ...
              <div className="flex flex-1 text-base">
                ...
                <input
                  name="uid"
                  className="hidden"
                  defaultValue={`${profile?.accounts[0].providerAccountId}`}
                />
              </div>
          ...
          <button
            type="submit"
            className="text-white mb-20 mt-10 font-SCGBold bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg w-full px-5 py-2.5 text-center "
          >
            Submit
          </button>
        </form>
