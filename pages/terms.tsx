...
export default function term() {
  return (
    <div>
      <div className="flex  items-center justify-center py-12 px-10 sm:px-6 lg:px-8">
        <div className="text-center w-full max-w-md">
          <Logo></Logo>
          <p className="mt-10 font-SCGBold text-4xl">Terms &amp; Conditions</p>
          <p>Updated at 2022-12-16</p>
        </div>
      </div>
      <div className="px-10">
        {/* General Terms */}
        <div>
          <p className=" font-SCGBold text-xl">General Terms</p>
          <span>
        ...
        {/* License */}
        <div>
          <p className="font-SCGBold text-xl mt-10">License</p>
          <span>
            <b>SCG Badminton Academy</b> grants you a revocable, non-exclusive,
            ...
            <a> SCG Badminton Academy</a> (referred to in these Terms &amp;
            Conditions as "<a>SCG Badminton Academy</a>", "us", "we" or "our"),
            the provider of the <a>SCG Badminton Academy</a> website and the
            services accessible from the <a>SCG Badminton Academy </a>
            website (which are collectively referred to in these Terms &amp;
            Conditions as the "<a>SCG Badminton Academy</a> Service").
            <br />
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">
            Definitions and key terms
          </p>
          <span className="font-SCGRegular">
          ...
          <ul>
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Cookie:</a> small amount of data
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Company:</a> when this policy
                mentions “Company,” “we,” “us,” or “our,” it refers to{" "}
                <a>SCG Badminton Academy</a>,
                <a>1 Siam Cement Road, Bangsue, Bangkok 10800 Thailand</a> that
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Country:</a> where{" "}
                <a>SCG Badminton Academy</a> or the owners/founders of{" "}
                <a>SCG Badminton Academy</a> are based, in this case is{" "}
                <a>Thailand</a>.<br />
              </span>
            </li>
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Customer:</a> refers to the company,
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Device:</a> any internet connected
                device such as a phone, tablet, computer or any other device
                that can be used to visit <a>SCG Badminton Academy</a> and use
                the services.
                <br />
              </span>
            </li>
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">IP address:</a> Every device
            ...
            <li>
              <span className="font-SCGRegular">
                ...
                employed by <a>SCG Badminton Academy</a> or are under contract
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Personal Data:</a> any information
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Service:</a> refers to the service
                provided by
                <a> SCG Badminton Academy</a> as described in the relative terms
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Third-party service:</a> refers to
            ...
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">Website:</a>
                <a> SCG Badminton Academy</a>’s site, which can be accessed via
                this URL: <a>___________</a>
                <br />
              </span>
            </li>
            <li>
              <span className="font-SCGRegular">
                <a className="font-SCGBold">You:</a> a person or entity that is
                registered with
                <a> SCG Badminton Academy</a> to use the Services.
                <br />
              </span>
            </li>
          </ul>
        ...
        {/* Restrictions */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Restrictions</p>
          <span className="font-SCGRegular">
        ...
        {/* Payment */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Payment</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Return and Refund Policy</p>
          <span className="font-SCGRegular">
        ...
        {/* Your Suggestions */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Your Suggestions</p>
          <span className="font-SCGRegular">
        ...
        {/* Your Consent */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Your Consent</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Links to Other Websites</p>
          <span className="font-SCGRegular">
        ...
        {/* Cookies */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Cookies</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Updates to Our service</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Third-Party Services</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Term and Termination</p>
          <span className="font-SCGRegular">
        ...
        {/* Indemnification */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Indemnification</p>
          <span className="font-SCGRegular">
        ...
        {/* No Warranties */}
        <div>
          <p className="font-SCGBold text-xl mt-10">No Warranties</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Limitation of Liability</p>
          <span className="font-SCGRegular">
        ...
        {/* Severability */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Severability</p>
          <span className="font-SCGRegular">
        ...
        {/* Waiver */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Waiver</p>
          <span className="font-SCGRegular">
        ...
        {/* Entire Agreement */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Entire Agreement</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Updates to Our Terms</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Intellectual Property</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Agreement to Arbitrate</p>
          <span className="font-SCGRegular">
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR SCG Badminton
            Academy’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any
        ...
        {/* Notice of Dispute */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Notice of Dispute</p>
          <span className="font-SCGRegular">
        ...
        {/* Binding Arbitration */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Binding Arbitration</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Submissions and Privacy</p>
          <span className="font-SCGRegular">
        ...
        {/* Promotions */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Promotions</p>
          <span className="font-SCGRegular">
        ...
        <div>
          <p className="font-SCGBold text-xl mt-10">Typographical Errors</p>
          <span className="font-SCGRegular">
        ...
        {/* Miscellaneous */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Miscellaneous</p>
          <span className="font-SCGRegular">
        ...
        {/* Disclaimer */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Disclaimer</p>
          <span className="font-SCGRegular">
            ...
            our Service. Without limiting the foregoing, We specifically
            disclaim all warranties and representations in any content
            transmitted on or in connection with our Service or on sites that
            may appear as links on our Service, or in the products provided as a
            part of, or otherwise in connection with, our Service, including
            ...
            warrant that our Service will be uninterrupted, uncorrupted, timely,
            or error-free.
          </span>
        </div>
        ...
        {/* Contact Us */}
        <div>
          <p className="font-SCGBold text-xl mt-10">Contact Us</p>
          <span className="font-SCGRegular">
          ...
          <ul>
            <li>
              <span className="font-SCGRegular">
                Via Email: <a>ict@scgbadmintonacademy.com</a>
              </span>
            </li>
            <li>
              <span className="font-SCGRegular">
                Via this Link: <a>https://www.scgbadmintonacademy.com</a>
              </span>
            </li>
          </ul>
        </div>
