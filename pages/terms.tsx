    ...
    <div className="flex min-h-full items-center justify-center h-screen pl-10 pr-10 py-12 px-4 sm:px-6 lg:px-8">
      <div className=" ">
        ...
        <div className="">
          ...
          <p>Updated at 2022-12-16</p> <br /> <h1>General Terms</h1>
          <p className="">
            <span className="">
          ...
          <p className="p10">
            <span className="s1">
              <a>SCG Badminton Academy</a> grants you a revocable,
              non-exclusive, non- transferable, limited license to download,
              install and use our service strictly in accordance with the terms
              of this Agreement.
              <br />
              <br />
              These Terms &amp; Conditions are a contract between you and
              <a>SCG Badminton Academy</a> (referred to in these Terms &amp;
              Conditions as "<a>SCG Badminton Academy</a>", "us", "we" or
              "our"), the provider of the <a>SCG Badminton Academy</a> website
              and the services accessible from the <a>SCG Badminton Academy</a>
          ...
          <ul className="ul1">
            ...
            <li className="li8">
              <span className="s1">
                ...
                “we,” “us,” or “our,” it refers to <a>SCG Badminton Academy</a>,
            ...
            <li className="li8">
              <span className="s1">
                <strong>Country:</strong> where <a>SCG Badminton Academy</a> or
                the owners/founders of <a>SCG Badminton Academy</a> are based,
                in this case is <a>Thailand</a>.<br />
              </span>
            </li>
            <li className="li8">
              <span className="s1">
                <strong>Customer:</strong> refers to the company, organization
                or person that signs up to use the <a>SCG Badminton Academy</a>
            ...
            <li className="li8">
              <span className="s1">
                ...
                visit <a>SCG Badminton Academy</a> and use the services.
                <br />
              </span>
            </li>
            <li className="li8">
            ...
            <li className="li8">
              <span className="s1">
                <strong>Website:</strong> <a>SCG Badminton Academy</a>’s site,
                which can be accessed via this URL: <a>___________</a>
                <br />
              </span>
            </li>
            <li className="li8">
          ...
          <p className="p10">
            <span className="s1">
              ...
              that each fee or charge is due and payable. Your Payment Provider
              ...
              to verify information immediately, and subsequently invoice your
              account for all fees and charges due and payable to us hereunder
              ...
              credit card used for payment hereunder. We reserve the right at
              any time to change its prices and billing methods, either
              immediately upon posting on our Site or by e-mail delivery to your
              organization’s administrator(s). Any attorney fees, court costs,
              or other costs incurred in collection of delinquent undisputed
              amounts shall be the responsibility of and paid for by you. No
              contract will exist between you and us for the Service until we
              accept your order by a confirmatory e-mail, SMS/MMS message, or
          ...
          <p className="p10">
            <span className="s1">
              ...
              Academy’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means
